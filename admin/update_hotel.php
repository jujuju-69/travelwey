...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $sql = "SELECT id, name, price, rating, location,  image, destination_name
            FROM hotels
            WHERE id = $hotelId";
            ...
            <div class="page-content">
                <div class="edit-hotel-form">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $hotelId; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" id="destination_name" name="destination_name" value="<?php echo htmlspecialchars($hotel['destination_name']); ?>" required>
